# 👋 Olá | Hello, I’m Paloma França Fernandes

🎯 **Analista de Business Intelligence | Business Intelligence Analyst**  
📊 Apaixonada por transformar dados em **insights estratégicos**, aplicando **Data Science, EDA, Machine Learning e Estatística** para apoiar a tomada de decisão.  
...
- **Destaques | Highlights**:  
  - Dashboards interativos e visuais | Interactive and visual dashboards  
  - Identificação de padrões em grandes volumes de dados | Pattern detection in large datasets  
  - Automação de relatórios e processos analíticos | Automation of analytical processes  
